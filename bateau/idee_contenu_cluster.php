...
// === CONFIGURATION ===
$config = [
    'table_id' => 'mfqmt3oxfzmn1oi',
    'project' => 'D4SEO_KEYWORD_CLUSTER_ARTICLE',
    'table' => 'Content_Ideas_from_Clusters',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['Id'])) {
    ...
    $data = [
        ...
        'Cluster Name' => filter_input(INPUT_POST, 'Cluster Name', FILTER_SANITIZE_STRING) ?? '',
...
<head>
    <meta charset="UTF-8">
    <title>Idée d'article par cluster</title>
...
<?php include("nav.php"); ?>
    ...
    <h1>Idée d'article par cluster</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($row['Cluster Name'] ?? '') ?></td>
